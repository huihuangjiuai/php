...
<!-- <script src="./static/tools/gt.js"></script> -->
...
<script>
    ...
    $.ajax({
        // 获取id，challenge，success（是否启用failback）
        url: "http://frontend.localhost.com/index.php?r=test-opencc/start-captcha-servlet&type=mobile&t=" + (new Date()).getTime(), // 加随机数防止缓存
        type: "get",
        dataType: "json",
        success: function (data) {
            // 使用initGeetest接口
